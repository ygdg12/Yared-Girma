...
const PROJECTS = [
  {
    ...
    tags: ['React', 'Vite', 'UI'],
    url: 'https://las-vegas-seven.vercel.app/',
    year: '2026',
    type: 'Website',
  },
  {
    id: '02',
    title: 'Tsedey Activewear',
    subtitle: 'Sports Clothing Brand',
    desc: 'A frontend storefront experience for Tsedey Activewear — product browsing and brand presentation with a polished UI.',
    tags: ['React', 'Vite', 'E-commerce UI'],
    url: 'https://tsedey-frontend.vercel.app/',
    year: '2026',
    type: 'Brand Site',
  },
  {
